...
class KeysightENAChannelError(Exception):
    """
    """
    pass


class KeysightENAChannel(BaseInstrument):
    """
    """
    _channel = 1
    port = 1
    ...
    def __init__(self, pna, channel_num, caching_allowed=True,
                 caching_permissions={}):
        super(KeysightENAChannel, self).__init__(None, caching_allowed,
                                                caching_permissions)
        self._pna = pna
    ...
    def prepare_sweep(self, sweep_type, start, stop, sweep_points):
        ...
        if sweep_type == 'FREQUENCY':
            ...
            raise KeysightENAChannelError(cleandoc('''Unsupported type of sweep
    ...
    def tracenb(self, value):
        ...
        """
        self.current_meas = [self._channel, value]
...
class KeysightENA(VisaInstrument):
    """
    """
    ...
    def get_channel(self, num):
        ...
        if num in self.channels:
            ...
            channel = KeysightENAChannel(self, num)
